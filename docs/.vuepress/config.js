...
export default defineUserConfig({
    ...
    plugins: [
        mdEnhancePlugin({
            //vuepress-plugin-md-enhance 在 2.0 版本中废弃了,npm install -D @vuepress/plugin-markdown-image@next @vuepress/plugin-markdown-tab@next
            // 选项卡
            //tabs: true,
            // 启用图片 figure
            // figure: true,
        ...
        // 新增：图片增强插件（替代原来的 figure, imgLazyload, imgMark, imgSize）
        markdownImagePlugin({
            // 启用 figure
            figure: true,
            // 启用懒加载
